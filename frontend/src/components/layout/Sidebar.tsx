  ...
  return (
    ...
    >
      ...
      >
        ...
        <List>
          <ListItemButton selected={isActive(ROUTES.HOME)} onClick={() => handleNavigate(ROUTES.HOME)}>
            <ListItemIcon><HomeIcon /></ListItemIcon>
            <ListItemText primary={t('sidebar.home')} />
          </ListItemButton>
          <ListItemButton selected={isActive(ROUTES.DOCUMENTS)} onClick={() => handleNavigate(ROUTES.DOCUMENTS)}>
            <ListItemIcon><DescriptionIcon /></ListItemIcon>
            <ListItemText primary={t('sidebar.documents')} />
          </ListItemButton>
          <ListItemButton selected={isActive(ROUTES.GROUPS)} onClick={() => handleNavigate(ROUTES.GROUPS)}>
